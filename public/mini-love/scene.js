...
const SKY = [
  ...
  { z: [0.14, 0.15, 0.38], m: [0.46, 0.32, 0.56], h: [0.98, 0.62, 0.52], sun: [1.0, 0.68, 0.46], sunI: 1.0, hs: [0.66, 0.52, 0.72], hg: [0.4, 0.3, 0.3], hI: 0.75, fog: 0.022 },
  { z: [0.012, 0.02, 0.075], m: [0.04, 0.07, 0.2], h: [0.13, 0.12, 0.3], sun: [0.62, 0.7, 1.0], sunI: 0.5, hs: [0.22, 0.28, 0.55], hg: [0.08, 0.08, 0.16], hI: 0.62, fog: 0.02 },
];
const skyAt = (phase) => {
...
/* 阅读进度 s：0 封面，1–5 对应五个乐章开头，6 读完；每章两个机位 */
const PATH = [
  { s: 0, p: [0.4, 5.6, 13.8], l: [0, 1.0, 0.6], ph: 0.05 },
  { s: 1, p: [-7.4, 3.0, 5.4], l: [-3.6, 1.1, -0.4], ph: 0.15 },
  { s: 1.7, p: [5.6, 2.6, 4.2], l: [2.4, 1.6, -2.0], ph: 0.45 },
  { s: 2, p: [6.2, 3.1, -8.6], l: [0.8, 0.9, -14.6], ph: 1.0 },
  { s: 2.7, p: [-0.4, 2.5, -12.2], l: [-3.2, 1.4, -17.6], ph: 1.25 },
  { s: 3, p: [-3.6, 2.4, -20.8], l: [0.3, 1.2, -28.4], ph: 2.0 },
  { s: 3.7, p: [3.4, 2.2, -25.6], l: [-1.2, 1.5, -31.6], ph: 2.25 },
  { s: 4, p: [1.8, 2.6, -33.6], l: [0, 3.0, -44.0], ph: 2.75 },
  { s: 4.7, p: [-1.8, 3.9, -39.8], l: [-0.6, 3.6, -45.6], ph: 2.95 },
  { s: 5, p: [0.9, 3.8, -39.9], l: [0, 3.3, -43.8], ph: 3.0 },
  { s: 5.7, p: [0.0, 4.6, -38.4], l: [0, 3.6, -45.0], ph: 3.0 },
  { s: 6, p: [0, 8.4, -30.5], l: [0, 5.4, -56], ph: 3.0 },
];
const YES_SHOT = { p: [0.6, 3.75, -40.9], l: [0, 3.35, -43.6] };
...
export async function mountIsland(canvas, { reduced = false } = {}) {
  ...
  const step = (now) => {
    ...
    wantPos.addScaledVector(forward, hold * 1.4);
